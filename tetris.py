...
game_bg = pygame.image.load('фон.jpg').convert()


main_font = pygame.font.Font('TETRIS.otf', 65)
font = pygame.font.Font('TETRIS.otf', 45)

title_tetris = main_font.render('TETRIS', True, pygame.Color('darkorange'))
title_score = font.render('СЧЕТ:', True, pygame.Color('green'))
